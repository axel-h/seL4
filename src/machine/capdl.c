...
void obj_sc_print_attrs(cap_t sc_cap)
{
    ...
    printf("(period: %"PRIu64" ticks (%"PRIu64" us), budget: %"PRIu64 "ticks "
           "(%"PRIu64" us), %"SEL4_PRIu_word" bits)\n",
           _from_time_t(ticksToUs(period)), period,
           _from_time_t(ticksToUs(budget)), budget,
