...
)
{
    ...
    populate_bi_frame(0, ksNumCPUs, ipcbuf_vptr, num_bi_pages, extra_bi_size);
    pptr_t extra_bi = rootserver.boot_info + SEL4_BI_FRAME_SIZE;
    pptr_t extra_bi_end = extra_bi + ROUND_UP(extra_bi_size, PAGE_BITS);
