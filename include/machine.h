...
static inline p_region_t CONST kpptr_to_paddr_reg(const region_t reg)
{
    return (p_region_t) {
        .start = kpptr_to_paddr((const void *)reg.start),
        .end   = kpptr_to_paddr((const void *)reg.end),
    };
}
...
{
    return kpptr_to_paddr_reg((region_t) {
